...
class Train(object):
    ...
    def train_model(self, model, train_dataset, val_datasets, test_datasets):
        ...
        train_contrast_labels = np.array(train_dataset["contrast"])
        ...
        val_contrast_labels = np.array(val_datasets["val_dataset"]["contrast"])

        train_dataset = (train_sentences, [train_sentiment_labels, train_rule_masks, train_contrast_labels])
        val_dataset = (val_sentences, [val_sentiment_labels, val_rule_masks, val_contrast_labels])
        ...
        for key, value in test_datasets.items():
            ...
            contrast_labels = np.array(test_datasets[key]["contrast"])
            dataset = (sentences, [sentiment_labels, rule_masks, contrast_labels], key)
