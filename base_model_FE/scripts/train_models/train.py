...
class Train(object):
    ...
    def train_model(self, model, train_dataset, val_datasets, test_datasets):
        ...
        train_dataset = ([train_sentences, train_rule_masks], train_sentiment_labels)
        val_dataset = ([val_sentences, val_rule_masks], val_sentiment_labels)
        ...
        for key, value in test_datasets.items():
            ...
            dataset = ([sentences, rule_masks], sentiment_labels, key)
